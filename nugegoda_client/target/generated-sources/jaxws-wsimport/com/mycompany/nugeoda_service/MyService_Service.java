 ...
 * 
 */
@WebServiceClient(name = "MyService", targetNamespace = "http://nugeoda_service.mycompany.com/", wsdlLocation = "http://localhost:8080/nugeoda_service/MyService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICE_QNAME = new QName("http://nugeoda_service.mycompany.com/", "MyService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/nugeoda_service/MyService?wsdl");
    ...
    public MyService getMyServicePort() {
        return super.getPort(new QName("http://nugeoda_service.mycompany.com/", "MyServicePort"), MyService.class);
    }
    ...
    public MyService getMyServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://nugeoda_service.mycompany.com/", "MyServicePort"), MyService.class, features);
    }
